...
const Form = () => {
  ...
  const AllowedEmails = [
    ...
    "divyansh.229301122@muj.manipal.edu",
    "hamza.229301131@muj.manipal.edu",
    "pranav.229301136@muj.manipal.edu",
    "maurvi.229301138@muj.manipal.edu",
    "vishal.229301139@muj.manipal.edu",
    "devansh.229301140@muj.manipal.edu",
    "avishi.229301154@muj.manipal.edu",
    "karan.229301168@muj.manipal.edu",
    "harshit.229301174@muj.manipal.edu",
    "jheel.229301200@muj.manipal.edu",
    "utkarsh.229301202@muj.manipal.edu",
    "ashutosh.229301222@muj.manipal.edu",
    "arhaan.229301232@muj.manipal.edu",
    "shivansh.229301261@muj.manipal.edu",
    "tapish.229301266@muj.manipal.edu",
    "sidhant.229301301@muj.manipal.edu",
    "akanksha.229301404@muj.manipal.edu",
    "anish.229301442@muj.manipal.edu",
    "prerna.229301453@muj.manipal.edu",
    "sanchit.229301463@muj.manipal.edu",
    "s.ankit.229301470@muj.manipal.edu",
    "aryan.229301478@muj.manipal.edu",
    "arnav.229301489@muj.manipal.edu",
    "vedant.229301498@muj.manipal.edu",
    "amey.229301519@muj.manipal.edu",
    "yash.229301525@muj.manipal.edu",
    "abhinav.229301532@muj.manipal.edu",
    "satya.229301537@muj.manipal.edu",
    "aditi.229301546@muj.manipal.edu",
    "raskar.229301547@muj.manipal.edu",
    "navneet.229301568@muj.manipal.edu",
    "kshitij.229301573@muj.manipal.edu",
    "kevin.229301592@muj.manipal.edu",
    "dheeraj.229301593@muj.manipal.edu",
    "sourodeep.229301618@muj.manipal.edu",
    "nishant.229301635@muj.manipal.edu",
    "mali.229301669@muj.manipal.edu",
    "ishaan.229301676@muj.manipal.edu",
    "armaan.229301681@muj.manipal.edu",
    "divyansh.229301713@muj.manipal.edu",
    "harsh.229301722@muj.manipal.edu",
    "gatik.229301725@muj.manipal.edu",
    "shaurya.229301726@muj.manipal.edu",
    "mohit.229301742@muj.manipal.edu",
    "rohan.229301747@muj.manipal.edu",
    "daksh.229301749@muj.manipal.edu",
    "saanvi.229301754@muj.manipal.edu",
    "vaidehi.229301755@muj.manipal.edu",
    "aayani.229301786@muj.manipal.edu",
    "abhay.229301798@muj.manipal.edu",
    "parth.229302160@muj.manipal.edu",
    "raghav.229302175@muj.manipal.edu",
    "shriyam.229302281@muj.manipal.edu",
    "taanya.229309005@muj.manipal.edu",
    "chandana.229309159@muj.manipal.edu",
    "rishit.229310231@muj.manipal.edu",
    "a.229310308@muj.manipal.edu",
    "sujay.229310319@muj.manipal.edu",
  ];
  ...
  const handleEmailChange = (e) => {
    ...
    setOutlookMail(value);

    // Check if the complete email exists in the allowed list
    const completeEmail = `${value}@muj.manipal.edu`;
    setIsValidEmail(AllowedEmails.includes(completeEmail));
  };
  ...
  const handleFileChange = async (e) => {
    ...
    if (selectedFile && selectedFile.type === "application/pdf") {
      ...
      // Only verify if they passed NPTEL
      if (passedNptel === "Yes") {
        setIsVerifying(true);
        const formData = new FormData();
        formData.append("file", selectedFile);
        ...
        // Automatically verify non-NPTEL certificates
        setIsCertificateVerified(true);
      }
    } else {
      toast.error("Please select a valid PDF file");
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("semester", semester);
    formData.append("subject", subject);
    formData.append("outlookMail", outlookMail);
    formData.append("passedNptel", passedNptel);
    formData.append("otherExam", otherExam);
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <motion.div
                    ...
                    className="relative w-full"
                  >
                    {/* Mail icon with divider */}
                    <div className="absolute inset-y-0 left-0 flex items-center pl-2 sm:pl-3 pointer-events-none">
                      <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500" />
                      <div className="w-px h-4 sm:h-5 bg-gray-300 ml-2 sm:ml-3"></div>
                    </div>

                    {/* Input field */}
                    <input
                      type="text"
                      placeholder="Enter MUJ outlook id"
                      value={outlookMail}
                      onChange={handleEmailChange}
                      className="w-full px-2 sm:px-3 py-2 pl-10 sm:pl-14 pr-[125px] sm:pr-[140px] border border-amber-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 transition duration-150 ease-in-out text-xs sm:text-sm bg-white bg-opacity-80 placeholder:text-gray-500"
                    />

                    {/* Container for validation icon and suffix */}
                    <div className="absolute inset-y-0 right-0 flex items-center">
                      ...
                      {/* Email suffix span */}
                      <span className="flex items-center justify-center bg-gray-200 h-[calc(100%-2px)] rounded-r-md border-l border-amber-300 text-gray-800 text-[10px] sm:text-xs px-2 sm:px-3">
                        @muj.manipal.edu
                      </span>
                    </div>
                  </motion.div>
                  ...
                  <motion.button
                    ...
                    whileHover={{
                      scale: isValidEmail && !otpLoading ? 1.05 : 1,
                    }}
                    whileTap={{ scale: isValidEmail && !otpLoading ? 0.95 : 1 }}
                    className={`w-full sm:w-auto px-4 py-2 rounded-md transition-all duration-150 ease-in-out font-medium text-sm sm:text-base flex items-center justify-center
                  ${
                    isValidEmail && !otpLoading
                        ...
                        <div className="flex flex-col">
                          <div className="flex">
                            ...
                            <div className="ml-3">
                              ...
                              <div className="mt-1 text-sm text-red-700">
                                Certificate verification failed - contents do
                                not match
                              </div>
                              {!showDetails && (
                                <button
                          ...
                          {showDetails && (
                            <div className="mt-4 bg-red-100 p-3 rounded-md">
                              <p className="text-sm text-red-700">
                                ...
                                against our records. Please ensure you've
                                uploaded the correct NPTEL certificate.
                              </p>
                            </div>
                          )}
                          <button
                          ...
                          >
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                d="M4.755 10.059a7.5 7.5 0 0112.548-3.364l1.903.619a.75.75 0 11-.484 1.42l-1.903-.62a7.5 7.5 0 11-12.064 1.945zm5.245-3.59L8.418 7.988a.75.75 0 01-.293 1.024l-1.292.97a.75.75 0 11-.9-1.2l1.292-.97a.75.75 0 011.024.294l1.582 1.52a.75.75 0 01-.02 1.062l-2.5 2.5a.75.75 0 11-1.06-1.06l2.5-2.5a.75.75 0 01.02-1.062z"
                                clipRule="evenodd"
                              />
                            </svg>
                            Try Again
